...
namespace ProxyApiQualtech.Services.ControllerEntryData
{
    public interface IEntryDataInterpreter
    {
        ...
        Task<QualtechInternalHttpRequesterResponse> QualtechInternalHttpRequester(EntryDataModel entryData);
        ...
        Task<string> GenerateEpicorApiBearer(string epiEnv,EntryDataModel entryData);
    }
}
